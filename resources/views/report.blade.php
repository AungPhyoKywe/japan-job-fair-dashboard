            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <input type="date" class="form-control box1" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2">
                        <button class="btn btn-primary input-group">Show</button>
                    ...
                    <div class="col-3">
                        ...
                        <a href="/cv_report" class="btn btn-primary input-group">Excel Export</a>
                    </div>
                    ...
                    <div class="col-3">
                        ...
                        <button class="btn btn-primary input-group">Download CV Form</button>
                    ...
                    <table id="example" class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col">English Skill</th>
                            <th scope="col">Japanese Skill</th>
                            <th scope="col">CV</th>
                        ...
                        <tr>
                            ...
                            <td>{{$cv->current_country}}</td>
                            <td>{{$cv->english_skill}}</td>
                            <td>{{$cv->japanese_skill}}</td>
                            <td>{{$cv->cv}}</td>
                            <td>{{$cv->upload_at}}</td>
                        </tr>
                        @endforeach
